...
- OkHttp + RestClient for HTTP clients (3-minute read timeout for AI APIs)
...
- Supports both OkHttpClient and Spring RestClient
...
- **ElevenLabs** - Text-to-speech narration and sound effects
