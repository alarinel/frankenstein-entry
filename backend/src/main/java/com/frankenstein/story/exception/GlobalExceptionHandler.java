...
public class GlobalExceptionHandler {
   ...
   public ResponseEntity<ErrorResponse> handleStoryGenerationException(StoryGenerationException ex, WebRequest request) {
   ...
   public ResponseEntity<ErrorResponse> handleImageGenerationException(ImageGenerationException ex, WebRequest request) {
   ...
   public ResponseEntity<ErrorResponse> handleAudioGenerationException(AudioGenerationException ex, WebRequest request) {
