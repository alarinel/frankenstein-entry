...
public class AssetController {
   ...
   public ResponseEntity<byte[]> getImage(@PathVariable String storyId, @PathVariable int pageNumber) {
      try {
   ...
   public ResponseEntity<byte[]> getNarration(@PathVariable String storyId, @PathVariable int pageNumber) {
      try {
   ...
   public ResponseEntity<byte[]> getSoundEffect(@PathVariable String storyId, @PathVariable String effectName) {
      try {
