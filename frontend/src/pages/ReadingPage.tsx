...
import { useReadingPageState, useReadingPageHandlers } from '@/hooks/reading';
  ...
  return (
    <div className={`h-screen bg-gradient-to-br ${theme.from} ${theme.via} ${theme.to} flex flex-col overflow-hidden relative`}>
      ...
      <div className="flex-1 flex flex-col items-center" style={{ padding: '0 clamp(0.5rem, 1.5vw, 1rem)', overflow: 'hidden' }}>
        <div className="w-full flex flex-col items-center h-full" style={{ maxWidth: '1600px', paddingTop: 'clamp(1.5rem, 3vh, 2.5rem)', paddingBottom: 'clamp(0.5rem, 1vh, 0.75rem)' }}>
          {/* Story Title */}
          <div className="w-full z-20" style={{ marginBottom: 'clamp(0.125rem, 0.25vh, 0.25rem)', flexShrink: 0 }}>
            <h1 
          ...
          <div className="flex-1 flex items-center justify-center w-full">
            <div className="w-full flex flex-col items-center h-full justify-center" style={{ gap: 'clamp(0.25rem, 0.75vh, 0.375rem)' }}>
              <Book3DDisplay
