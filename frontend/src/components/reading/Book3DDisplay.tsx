    ...
    >
      ...
      <div
        ...
        style={{
          ...
          height: 'clamp(500px, min(70vh, 900px), 1400px)',
          width: 'min(100%, calc((clamp(700px, min(70vh, 900px), 1400px)) * 4 / 3))',
          maxWidth: '1700px',
        }}
      >
        ...
        <div
          ...
          style={{
            ...
            background:
              'linear-gradient(to bottom, rgba(0,0,0,0.9) 0%, rgba(0,0,0,1) 50%, rgba(0,0,0,0.9) 100%)',
